...
<PageHead title={m.privacy_title()} description={m.privacy_intro()} />

<BaseLayout>
    <div class="container mx-auto max-w-4xl px-4 py-12">
        <CosmicButton href="/" variant="secondary" className="py-2! px-3! mb-6">
        ...
        <GlassCard className="animate-slide-up">
            <div class="mb-8 flex items-center gap-4">
                ...
                >
                    <Shield class="text-brand-gold h-6 w-6" />
                </div>
                <div>
                    ...
                    <p class="text-text-secondary text-sm">
                        {m.privacy_last_updated()}: January 1, 2026
                    </p>
                </div>
            </div>

            <p class="text-text-secondary mb-8 leading-relaxed font-light">
                {m.privacy_intro()}
            </p>

            <div class="space-y-8">
                <section>
                    <h2 class="mb-3 font-serif text-xl text-white">
